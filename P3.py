# WORKING
# VER 6 (ACCU AVG (TOL 5%))

# REMOVE REFERENCE SERIAL NO, PYTHON FILE NAME DISPLAY
#  FROM VER6A.py
# TRYING TO CHANGE THE LINE TREND TO SPC
# 75 DROPDOWN LIST COMBOBOX 

# WITH TOLERANCE SELECTION AND DISPLAY AT 2ND TKINTER GUI
# HEADER CHANGE TO PYTHON FILE NAME
# CREATE FOCUS SELECTION
# FIXED: REMOVE FUTURE WARNING
# NEW SELECTION: GENERATE CSV FILE: 0 YES    0 NO
# CREATE FOCUS SELECTION
# SETTINGS COMBOBOX 75
...
class FluctuationMonitor:
    def __init__(self, root, location, generate_csv, tolerance, file_path, logic):
        self.root = root
        self.root.title(f"Fluctuation Status Monitor -  ({os.path.basename(__file__)})") # Display Python file name
    ...
    def process_and_update(self):
        ...
        try:
            ...
            for a in range(len(df)):
                ...
                elif self.logic in ["FIND THE NEAREST GOOD", "DUO (SINGLE NOZZLE) W/ 2 SERIAL NUMBER"]:
